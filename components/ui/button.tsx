...
function Button({
  ...
  return (
    <ButtonPrimitive
      ...
      // When `render` points at a non-<button> element (e.g. a Link), this
      // component isn't a native button — tell Base UI so it doesn't warn
      // about (and skip) native button semantics/keyboard handling.
